...
export const zhCNTerminalMessages: Messages = {
  ...
  'settings.sftp.transferConcurrency.desc': '同一目标同时传输的文件数量上限，包括文件夹内文件和单独多选的文件。较高的值可能提高速度，但可能导致某些服务器过载。',
  'settings.sftp.transferPoolIdleTtl': '传输连接保活时间',
  'settings.sftp.transferPoolIdleTtl.desc': '专用传输 SFTP 连接空闲多久后关闭。时间更长可减少下次上传/下载的冷启动等待；进行中的传输不会被关闭。',
  'settings.sftp.transferPoolIdleTtl.1m': '1 分钟',
  'settings.sftp.transferPoolIdleTtl.5m': '5 分钟',
  'settings.sftp.transferPoolIdleTtl.15m': '15 分钟',
  'settings.sftp.transferPoolIdleTtl.30m': '30 分钟',
  'settings.sftp.transferPoolIdleTtl.never': '直到退出应用',
  'settings.ssh.transportIdleTtl': 'SSH 连接保活时间',
  'settings.ssh.transportIdleTtl.desc': '最后一个终端、SFTP 浏览、批量传输或端口转发释放后，共享 SSH 连接再保留多久。保留期间再次打开同主机可跳过重新认证（含 MFA）；进行中的会话与传输不会被关闭。',
  'settings.ssh.transportIdleTtl.1m': '1 分钟',
  'settings.ssh.transportIdleTtl.5m': '5 分钟',
  'settings.ssh.transportIdleTtl.15m': '15 分钟',
  'settings.ssh.transportIdleTtl.30m': '30 分钟',
  'settings.ssh.transportIdleTtl.never': '直到退出应用',
  ...
  'settings.terminal.font.cjk.useCustom': '使用字体',
  'settings.terminal.font.cjk.refresh': '刷新本机字体',
  'settings.terminal.font.cjk.alignmentWarning': '这个字体尚未确认是等宽字体，请通过预览检查文字是否对齐。',
  'settings.terminal.font.cjk.unavailableWarning': '本机没有安装这个字体。Netcatty 会保留设置，并使用安全字体继续显示。',
  ...
  'settings.terminal.hostInfoBar.titleMode': '主机信息标题',
  ...
  'snippets.targets.title': '执行目标',
  'snippets.targets.add': '添加目标',
  'snippets.targets.selectHosts': '选择主机',
  'snippets.targets.selectGroups': '选择分组',
  'snippets.targets.noGroups': '未找到分组',
  ...
  'snippets.selection.deleteSelected': '删除（{count}）',
  'snippets.selection.deleteConfirmTitle': '删除选中的 {count} 项？',
  'snippets.selection.deleteConfirmDesc': '所选项目将被永久删除，此操作无法撤销。',
  'snippets.selection.deleteSuccess': '已删除 {count} 个所选项目。',
  ...
  'serial.field.backspaceBehavior': '回退键',
  'serial.field.backspaceBehaviorDesc': '如果网络设备不响应默认回退键，请改用 Ctrl+H。',
